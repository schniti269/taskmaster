defmodule TaskmasterWeb.TaskControllerTest do
  ...
  @create_attrs %{description: "some description", title: "some title", startdate: ~U[2025-03-22 01:08:00Z], length_in_min: 42, is_done: true}
  @update_attrs %{description: "some updated description", title: "some updated title", startdate: ~U[2025-03-23 01:08:00Z], length_in_min: 43, is_done: false}
  @invalid_attrs %{description: nil, title: nil, startdate: nil, length_in_min: nil, is_done: nil}
