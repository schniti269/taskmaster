...
config :taskmaster, Taskmaster.Repo,
  database: Path.expand("../taskmaster_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :taskmaster, TaskmasterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "+jTqig88bxzdVYaRukBZA67VbFm11LGimYD77RYvOzDkx4DfFV6OhGP4I3RUq9/r",
  watchers: [
...
config :taskmaster, TaskmasterWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/taskmaster_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
